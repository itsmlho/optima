...
-- Updated for existing database structure
-- ========================================
...
CREATE TABLE IF NOT EXISTS `unit_replacement_log` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `di_id` INT(11) NOT NULL,
  `old_unit_id` INT(11) UNSIGNED NOT NULL,
  `new_unit_id` INT(11) UNSIGNED NOT NULL,
  `kontrak_id` INT(11) NOT NULL,
  `stage` VARCHAR(50) NOT NULL,
...
('enhanced_di_workflow_v2', 'Enhanced DI Workflow for TARIK/TUKAR with contract management - Updated for existing schema', 'SUCCESS', 'Added workflow tracking, contract disconnection, and status management compatible with existing structure', NOW());

-- Update completed
SELECT 'Enhanced DI Workflow Migration V2 Completed Successfully!' as Result;