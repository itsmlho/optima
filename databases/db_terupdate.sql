...
-- Dumping data for table optima_db.delivery_instructions: ~7 rows (approximately)
REPLACE INTO `delivery_instructions` (`id`, `nomor_di`, `spk_id`, `po_kontrak_nomor`, `pelanggan`, `lokasi`, `tanggal_kirim`, `catatan`, `status`, `dibuat_oleh`, `dibuat_pada`, `diperbarui_pada`, `perencanaan_tanggal_approve`, `estimasi_sampai`, `nama_supir`, `no_hp_supir`, `no_sim_supir`, `kendaraan`, `no_polisi_kendaraan`, `berangkat_tanggal_approve`, `catatan_berangkat`, `sampai_tanggal_approve`, `catatan_sampai`) VALUES
	...
	(14, 'DI/202508/007', NULL, 'test/1/1/10', 'PURI INDAH', 'Gemalapik', '2025-08-26', 'a', 'DELIVERED', 1, '2025-08-26 07:19:50', '2025-08-27 15:26:25', '2025-08-26', NULL, NULL, NULL, NULL, NULL, NULL, '2025-08-26', 'ok', '2025-08-26', 'a');
...
-- Dumping data for table optima_db.delivery_items: ~7 rows (approximately)
REPLACE INTO `delivery_items` (`id`, `di_id`, `item_type`, `unit_id`, `attachment_id`, `keterangan`) VALUES
	...
	(16, 14, 'UNIT', 6, NULL, NULL),
	(17, 14, 'UNIT', 9, NULL, NULL),
	(18, 14, 'UNIT', 11, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `inventory_attachment` (
  ...
  `sn_attachment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `baterai_id` int DEFAULT NULL,
  `sn_baterai` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `charger_id` int DEFAULT NULL COMMENT 'FK ke charger',
  `sn_charger` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kondisi_fisik` enum('Baik','Rusak Ringan','Rusak Berat') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Baik',
  `kelengkapan` enum('Lengkap','Tidak Lengkap') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Lengkap',
  `catatan_fisik` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `lokasi_penyimpanan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_unit` int DEFAULT '7',
  `tanggal_masuk` datetime DEFAULT (now()) COMMENT 'Tanggal masuk ke inventory',
  `catatan_inventory` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` datetime DEFAULT (now()),
  `updated_at` datetime DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_inventory_attachment`),
  KEY `idx_po_id` (`po_id`),
  KEY `idx_attachment_id` (`attachment_id`),
  KEY `idx_baterai_id` (`baterai_id`),
  ...
  CONSTRAINT `fk_inv_attachment_attachment` FOREIGN KEY (`attachment_id`) REFERENCES `attachment` (`id_attachment`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_inv_attachment_baterai` FOREIGN KEY (`baterai_id`) REFERENCES `baterai` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_inv_attachment_charger` FOREIGN KEY (`charger_id`) REFERENCES `charger` (`id_charger`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_inv_attachment_po` FOREIGN KEY (`po_id`) REFERENCES `purchase_orders` (`id_po`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Inventory fisik: attachment, baterai, charger';

-- Dumping data for table optima_db.inventory_attachment: ~13 rows (approximately)
REPLACE INTO `inventory_attachment` (`id_inventory_attachment`, `tipe_item`, `po_id`, `id_inventory_unit`, `attachment_id`, `sn_attachment`, `baterai_id`, `sn_baterai`, `charger_id`, `sn_charger`, `kondisi_fisik`, `kelengkapan`, `catatan_fisik`, `lokasi_penyimpanan`, `status_unit`, `tanggal_masuk`, `catatan_inventory`, `created_at`, `updated_at`) VALUES
	...
	(6, 'charger', 143, NULL, NULL, NULL, NULL, NULL, 5, '123', 'Baik', 'Lengkap', NULL, 'POS 1', 7, '2025-08-22 09:23:14', 'Dari verifikasi PO (Charger): Sesuai', '2025-08-22 09:23:14', '2025-08-27 11:41:47'),
	...
	(8, 'charger', 143, NULL, NULL, NULL, NULL, NULL, 5, '123', 'Baik', 'Lengkap', NULL, 'POS 1', 7, '2025-08-27 04:15:34', 'Dari verifikasi PO (Charger): Sesuai', '2025-08-27 04:15:34', '2025-08-27 11:41:47'),
...
CREATE TABLE IF NOT EXISTS `inventory_item_unit_log` (
  ...
  CONSTRAINT `fk_log_inv_attachment` FOREIGN KEY (`id_inventory_attachment`) REFERENCES `inventory_attachment` (`id_inventory_attachment`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `inventory_unit` (
  ...
  CONSTRAINT `inventory_unit_ibfk_15` FOREIGN KEY (`kontrak_spesifikasi_id`) REFERENCES `kontrak_spesifikasi` (`id`) ON DELETE SET NULL,
...
-- Dumping data for table optima_db.inventory_unit: ~14 rows (approximately)
REPLACE INTO `inventory_unit` (`id_inventory_unit`, `no_unit`, `serial_number`, `id_po`, `tahun_unit`, `status_unit_id`, `status_aset`, `lokasi_unit`, `departemen_id`, `tanggal_kirim`, `keterangan`, `harga_sewa_bulanan`, `harga_sewa_harian`, `kontrak_id`, `kontrak_spesifikasi_id`, `tipe_unit_id`, `model_unit_id`, `kapasitas_unit_id`, `model_mast_id`, `tinggi_mast`, `sn_mast`, `model_mesin_id`, `sn_mesin`, `model_attachment_id`, `sn_attachment`, `model_baterai_id`, `sn_baterai`, `model_charger_id`, `sn_charger`, `roda_id`, `ban_id`, `valve_id`, `created_at`, `updated_at`) VALUES
	(1, 1, NULL, 122, '2025', 3, 0, 'Warehouse', 2, NULL, '', NULL, NULL, 1, NULL, 9, 6, 2, 5, NULL, '', 4, '', NULL, '', NULL, '', NULL, '', 4, 3, 4, '2025-08-12 02:22:14', '2025-08-19 11:38:34'),
	...
	(8, 11, 'andara', 39, '2025', 3, NULL, 'POS 1', 2, NULL, NULL, NULL, NULL, NULL, NULL, 2, 1, 30, 1, NULL, 'andara', 3, 'andara', NULL, NULL, 6, 'andara', NULL, NULL, 1, 3, 1, '2025-08-12 08:15:40', '2025-08-26 16:48:09'),
	...
	(14, 12, '123', 39, '2025', 3, NULL, 'POS 1', 2, NULL, NULL, NULL, NULL, NULL, NULL, 2, 1, 3, 1, NULL, '123', 3, '123', NULL, NULL, 6, '123', NULL, NULL, 1, 3, 1, '2025-08-27 02:22:59', '2025-08-27 13:31:31'),
	(15, 13, '123', 39, '2025', 3, NULL, 'POS 1', 2, NULL, NULL, NULL, NULL, NULL, NULL, 2, 1, 3, 1, NULL, '123', 3, '123', NULL, NULL, 6, '123', NULL, NULL, 1, 3, 1, '2025-08-27 02:23:14', '2025-08-27 13:51:14');
...
REPLACE INTO `kontrak` (`id`, `no_kontrak`, `no_po_marketing`, `pelanggan`, `lokasi`, `pic`, `kontak`, `nilai_total`, `total_units`, `jenis_sewa`, `tanggal_mulai`, `tanggal_berakhir`, `status`, `dibuat_oleh`, `dibuat_pada`, `diperbarui_pada`) VALUES
	...
	(3, '003/SML/RENT/VI/2024', 'PO-CL-0350', 'PT. Maju Bersama Sejahtera', 'Sunter, Jakarta Utara', NULL, NULL, NULL, 0, 'BULANAN', '2024-06-20', '2025-06-19', 'Aktif', 1, '2025-08-04 17:08:02', '2025-08-26 07:46:37'),
	(4, '004/SML/RENT/VII/2025', 'PO-CL-0488', 'PT. Angkasa Kargo', 'Area Kargo Bandara Soekarno-Hatta', NULL, NULL, NULL, 0, 'BULANAN', '2025-08-01', '2026-07-31', 'Aktif', 1, '2025-08-04 17:08:02', '2025-08-14 07:55:21'),
	(5, '005/SML/RENT/VIII/2025', 'PO-CL-0511', 'PT. Samudera Logistik', 'Tanjung Priok', NULL, NULL, NULL, 0, 'BULANAN', '2025-08-20', '2025-09-05', 'Aktif', 1, '2025-08-04 17:08:02', '2025-08-14 08:47:07'),
	(6, 'test/1/1/1', 'test/1/1/1', 'ADIT', '123', NULL, NULL, NULL, 0, 'BULANAN', '2025-08-15', '2025-08-17', 'Pending', 1, '2025-08-15 09:41:59', '2025-08-15 16:41:59'),
	...
	(8, 'test/1/1/3', '1233', 'kaleng', 'kaaleng', NULL, NULL, NULL, 0, 'BULANAN', '2025-08-19', '2025-08-19', 'Aktif', 1, '2025-08-19 02:47:02', '2025-08-19 02:55:17'),
...
CREATE TABLE IF NOT EXISTS `kontrak_spesifikasi` (
  ...
  KEY `departemen_id` (`departemen_id`),
  KEY `tipe_unit_id` (`tipe_unit_id`),
  KEY `kapasitas_id` (`kapasitas_id`),
  KEY `charger_id` (`charger_id`),
  KEY `mast_id` (`mast_id`),
  KEY `ban_id` (`ban_id`),
  KEY `roda_id` (`roda_id`),
  KEY `valve_id` (`valve_id`),
  CONSTRAINT `kontrak_spesifikasi_ibfk_1` FOREIGN KEY (`kontrak_id`) REFERENCES `kontrak` (`id`) ON DELETE CASCADE,
  CONSTRAINT `kontrak_spesifikasi_ibfk_2` FOREIGN KEY (`departemen_id`) REFERENCES `departemen` (`id_departemen`) ON DELETE SET NULL,
  CONSTRAINT `kontrak_spesifikasi_ibfk_3` FOREIGN KEY (`tipe_unit_id`) REFERENCES `tipe_unit` (`id_tipe_unit`) ON DELETE SET NULL,
  CONSTRAINT `kontrak_spesifikasi_ibfk_4` FOREIGN KEY (`kapasitas_id`) REFERENCES `kapasitas` (`id_kapasitas`) ON DELETE SET NULL,
  CONSTRAINT `kontrak_spesifikasi_ibfk_5` FOREIGN KEY (`charger_id`) REFERENCES `charger` (`id_charger`) ON DELETE SET NULL,
  CONSTRAINT `kontrak_spesifikasi_ibfk_6` FOREIGN KEY (`mast_id`) REFERENCES `tipe_mast` (`id_mast`) ON DELETE SET NULL,
...
-- Dumping data for table optima_db.kontrak_spesifikasi: ~10 rows (approximately)
...
-- Dumping data for table optima_db.notifications: ~23 rows (approximately)
...
-- Dumping data for table optima_db.po_items: ~32 rows (approximately)
...
-- Dumping data for table optima_db.spk: ~2 rows (approximately)
...
-- Dumping structure for procedure optima_db.update_kontrak_totals_proc
DELIMITER //
...
-- Dumping structure for trigger optima_db.trg_inventory_attachment_consistency_insert
...
-- Dumping structure for trigger optima_db.trg_inventory_attachment_consistency_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Dumping structure for trigger optima_db.update_kontrak_totals_after_spek_delete
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `update_kontrak_totals_after_spek_delete` AFTER DELETE ON `kontrak_spesifikasi` FOR EACH ROW BEGIN
    CALL update_kontrak_totals_proc(OLD.kontrak_id);
END//
DELIMITER ;
SET SQL_MODE=@OLDTMP_SQL_MODE;

-- Dumping structure for trigger optima_db.update_kontrak_totals_after_spek_insert
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Dumping structure for trigger optima_db.update_kontrak_totals_after_spek_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Dumping structure for trigger optima_db.update_kontrak_totals_after_unit_delete
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Dumping structure for trigger optima_db.update_kontrak_totals_after_unit_insert
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Dumping structure for trigger optima_db.update_kontrak_totals_after_unit_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
