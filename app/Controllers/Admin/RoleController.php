...
class RoleController extends BaseController
{
    ...
    {
        if (!$this->hasPermission('admin.role_create')) {
    ...
    {
        if (!$this->hasPermission('admin.role_edit')) {
            return $this->response->setJSON(['success' => false, 'message' => 'Access denied'])->setStatusCode(403);
        }
    ...
    {
        if (!$this->hasPermission('admin.role_delete')) {
            return $this->response->setJSON(['success' => false, 'message' => 'Access denied'])->setStatusCode(403);
        }
    ...
    {
        // Replace this basic implementation with your actual permission checking logic
        $userId = session()->get('user_id');
        if (!$userId) {
            return false;
        }
        
        // Use your permission helper
        return can_access($permission, $userId);
    }
}