...
return [
    ...
    'unassigned_units'            => 'Unassigned Units',
    'auto_sync_from_contracts'    => 'Auto-Sync from Contracts',
    'area_summary_hint'           => 'Click an area row to see the units in that area.',
    'input_area_hint'             => 'Select an area for each customer location → click Save. All active units at that location will be auto-synced to the selected area. Use <strong>Auto-Sync from Contracts</strong> if location areas are already set.',
    'input_area_label'            => 'How to input data:',
    'all_locations'               => 'All Locations',
    'unassigned_area_label'       => 'Without Area',
    'assigned_area_label'         => 'With Area',
    ...
    'unassigned_units_hint'       => 'Units without an area. Assign manually here, or use the "Input Area per Location" tab for bulk assignment.',
    'area_units_panel'            => 'Units in Area',
    'no_units_in_area'            => 'No units in this area',
    'all_units_mapped'            => 'All units are already mapped to an area',
    'syncing'                     => 'Syncing...',
    'sync_confirm'                => "Sync unit areas based on customer_location.area_id from all active contracts?\n\nOnly units whose contract locations already have an area assigned will be updated.",
    'saving'                      => 'Saving...',
