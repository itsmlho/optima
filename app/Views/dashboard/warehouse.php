...
<div class="container-fluid" aria-label="Dashboard Warehouse & Assets" role="region">
    ...
    <div class="row mb-4" aria-label="Statistik Warehouse" role="list">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800" data-count="<?= $warehouse_stats['total_assets'] ?? 0 ?>">0</div>
                            <div class="text-xs text-success"><i class="fas fa-arrow-up" aria-hidden="true"></i> +3 unit baru</div>
                        </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="inventoryMovementsTable">
                            <thead>
                                <tr>
                                    <th>Date</th>
                                    <th>Item</th>
