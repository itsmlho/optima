...
<div class="container-fluid">
    ...
    <h4 class="fw-bold mb-3"><i class="fas fa-boxes me-2 text-info"></i><?= esc($page_title) ?></h4>

    <?php if (!empty($inventory_data['summary'])): ?>
        <div class="row mb-4">
            <?php foreach ($inventory_data['summary'] as $k => $v): ?>
                ...
                <div class="card shadow-sm h-100">
                    <div class="card-body d-flex flex-column flex-md-row justify-content-between gap-2">
                        ...
                        <div class="align-self-md-center">
                            <button type="button" class="btn btn-info btn-sm text-white" data-report-type="<?= esc($item['id'], 'attr') ?>">
