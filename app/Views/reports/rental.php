...
<div class="container-fluid">
    ...
    <h4 class="fw-bold mb-3"><i class="fas fa-handshake me-2 text-primary"></i><?= esc($page_title) ?></h4>

    <?php if (!empty($rental_data['summary'])): ?>
        <div class="row mb-4">
            <?php foreach ($rental_data['summary'] as $k => $v): ?>
                ...
                <div class="card shadow-sm h-100">
                    <div class="card-body d-flex flex-column flex-md-row justify-content-between gap-2">
                        ...
                        <div class="align-self-md-center">
                            <button type="button" class="btn btn-primary btn-sm" data-report-type="<?= esc($item['id'], 'attr') ?>">
