...
<div class="coming-soon-container">
    <div class="coming-soon-card">
        ...
        <!-- Title -->
        <h1 class="coming-soon-title">Invoice Management</h1>
        
        <div class="coming-soon-divider"></div>
        
        <!-- Subtitle -->
        <p class="coming-soon-subtitle">Sistem Manajemen Tagihan</p>
        
        <!-- Description -->
        <p class="coming-soon-description">
            Modul Invoice Management sedang dalam pengembangan untuk mengelola tagihan dan faktur. 
            Fitur ini akan membantu tim accounting dalam membuat, mengirim, dan melacak invoice.
        </p>
