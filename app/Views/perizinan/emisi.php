...
<div class="coming-soon-container">
    <div class="coming-soon-card">
        ...
        <!-- Title -->
        <h1 class="coming-soon-title">EMISI (Surat Izin Emisi Gas Buang)</h1>
        
        <div class="coming-soon-divider"></div>
        
        <!-- Subtitle -->
        <p class="coming-soon-subtitle">Sistem Manajemen Emisi</p>
        
        <!-- Description -->
        <p class="coming-soon-description">
            Modul EMISI sedang dalam pengembangan untuk mengelola surat izin emisi gas buang unit forklift. 
            Fitur ini akan membantu tim perizinan dalam memantau compliance lingkungan dan emisi.
        </p>
        ...
        <div class="coming-soon-features">
            <div class="feature-item">
                <i class="fas fa-leaf"></i>
                <span>Compliance Emisi</span>
            </div>
            <div class="feature-item">
                <i class="fas fa-chart-bar"></i>
                <span>Monitoring Gas</span>
            </div>
            <div class="feature-item">
