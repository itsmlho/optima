...
<div class="coming-soon-container">
    <div class="coming-soon-card">
        ...
        <!-- Title -->
        <h1 class="coming-soon-title">SILO (Surat Izin Layak Operasi)</h1>
        
        <div class="coming-soon-divider"></div>
        
        <!-- Subtitle -->
        <p class="coming-soon-subtitle">Sistem Manajemen Perizinan</p>
        
        <!-- Description -->
        <p class="coming-soon-description">
            Modul SILO sedang dalam pengembangan untuk mengelola surat izin layak operasi unit forklift. 
            Fitur ini akan membantu tim perizinan dalam mengatur dokumen legal dan compliance.
        </p>
