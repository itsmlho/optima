...
<?php
/**
 * PO Attachment Verification - Warehouse
...
<!-- Modal Verifikasi -->
<div class="modal fade modal-wide" id="modalVerification" tabindex="-1" aria-labelledby="modalVerificationLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="modalVerificationLabel"><i class="fas fa-clipboard-check me-2"></i>Formulir Inspeksi Item</h5>
            ...
            <div class="card table-card animate__animated animate__fadeIn">
                <div class="card-header bg-light p-3 text-center">
                    <h5 class="fw-bold m-0">
                        <i class="fas fa-info-circle me-2 text-secondary"></i>Detail: ${h(itemName)}
                    </h5>
                </div>
                <div class="card-body p-4">
                    <table class="table table-sm table-borderless">
                        <tr><td width="30%"><strong>Tipe Item</strong></td><td>: <span class="badge badge-soft-gray">${h(data.item_type)}</span></td></tr>
